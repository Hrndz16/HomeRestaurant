...
################################################################################
## Form generated from reading UI file 'editar_tiquetera.ui'
##
...
"")
        ...
        self.gridLayout_2.addWidget(self.val_day_lineEdit, 3, 1, 1, 1)

        self.name_label_2 = QLabel(self.data_frame)
        self.name_label_2.setObjectName(u"name_label_2")

        self.gridLayout_2.addWidget(self.name_label_2, 2, 0, 1, 1)

        self.name_label = QLabel(self.data_frame)
        self.name_label.setObjectName(u"name_label")

        self.gridLayout_2.addWidget(self.name_label, 1, 0, 1, 1, Qt.AlignLeft)
        ...
        self.gridLayout_2.addWidget(self.start_dateEdit, 1, 1, 1, 1)

        self.name_label_4 = QLabel(self.data_frame)
        self.name_label_4.setObjectName(u"name_label_4")

        self.gridLayout_2.addWidget(self.name_label_4, 4, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.val_all_lineEdit, 4, 1, 1, 1)

        self.name_label_3 = QLabel(self.data_frame)
        self.name_label_3.setObjectName(u"name_label_3")

        self.gridLayout_2.addWidget(self.name_label_3, 3, 0, 1, 1)

        self.end_dateEdit = QDateEdit(self.data_frame)
        self.end_dateEdit.setObjectName(u"end_dateEdit")
        self.end_dateEdit.setMinimumSize(QSize(129, 0))
        self.end_dateEdit.setMaximumSize(QSize(317, 16777215))

        self.gridLayout_2.addWidget(self.end_dateEdit, 1, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.num_days_lineEdit, 2, 1, 1, 1)
        ...
        self.edit_pushButton = QPushButton(self.buttons_frame)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(QCoreApplication.translate("Dialog", u"Tiquetera", None))
...
"Inicio/Fin:", None))
        ...
        self.edit_pushButton.setText(QCoreApplication.translate("Dialog", u"Editar", None))
