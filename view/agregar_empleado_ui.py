...
################################################################################
## Form generated from reading UI file 'agregar_empleado.ui'
##
...
class Ui_Dialog_agregar_empleado(object):
    def setupUi(self, Dialog):
        if not Dialog.objectName():
            Dialog.setObjectName(u"Dialog")
        Dialog.resize(328, 293)
...
"")
        ...
        self.gridLayout.addWidget(self.cc_label, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.cc_lineEdit, 2, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.cc_label.setText(QCoreApplication.translate("Dialog", u"NIT:", None))
        self.name_label_2.setText(QCoreApplication.translate("Dialog", u"Tipo de pructos", None))
