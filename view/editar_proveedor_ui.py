...
################################################################################
## Form generated from reading UI file 'editar_proveedor.ui'
##
...
"")
        ...
        self.nit_label = QLabel(self.data_frame)
        self.nit_label.setObjectName(u"nit_label")

        self.gridLayout.addWidget(self.nit_label, 2, 0, 1, 1, Qt.AlignRight)

        self.name_label_2 = QLabel(self.data_frame)
        self.name_label_2.setObjectName(u"name_label_2")

        self.gridLayout.addWidget(self.name_label_2, 4, 0, 1, 1)

        self.name_label = QLabel(self.data_frame)
        self.name_label.setObjectName(u"name_label")

        self.gridLayout.addWidget(self.name_label, 0, 0, 1, 1, Qt.AlignRight)

        self.nit_lineEdit = QLineEdit(self.data_frame)
        self.nit_lineEdit.setObjectName(u"nit_lineEdit")

        self.gridLayout.addWidget(self.nit_lineEdit, 2, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.nit_label.setText(QCoreApplication.translate("Dialog", u"NIT:", None))
        self.name_label_2.setText(QCoreApplication.translate("Dialog", u"Tipo de pruductos:", None))
