...
################################################################################
## Form generated from reading UI file 'admin_salarios.ui'
##
...
class Ui_Dialog_admin_salarios(object):
    def setupUi(self, Dialog):
        if not Dialog.objectName():
            Dialog.setObjectName(u"Dialog")
        Dialog.resize(366, 458)
...
"")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(QCoreApplication.translate("Dialog", u"Valor salario", None))
        self.label_4.setText(QCoreApplication.translate("Dialog", u"Total de todos\n"
" Los salarios", None))
        self.label.setText(QCoreApplication.translate("Dialog", u"No de empleados:", None))
